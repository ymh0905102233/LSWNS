...
public class BasisTimesUtils {
    ...
    /**
     * 将字符串时间转为Long时间     *     * @param time yyyy-MM-dd HH:mm:ss
     */
    ...
    /**
     * 将字符串时间转为Long时间     *     * @param time yyyy-MM-dd
     */
    ...
    /**
     * 将Long时间转成String时间     *     * @return yyyy-MM-dd HH:mm:ss:SSS
     */
    ...
    /**
     * 将Long时间转成String时间     *     * @return yyyy-MM-dd HH:mm:ss
     */
    ...
    /**
     * 将Long时间转成String时间     *     * @return yyyy-MM-dd
     */
    ...
    /**
     * 当前的时间(设备)     *     * @return yyyy-MM-dd HH:mm:ss:SSS
     */
    ...
    /**
     * 当前的时间(设备)     *     * @return yyyy-MM-dd HH:mm:ss
     */
    ...
    /**
     * 显示日期选择器     *     * @param themeLight true 白色背景; false 黑色背景
     */
     ...
     * 显示日期选择器
     */
    public static BasisTimesUtils showDatePickerDialog(Context context, int themeId, String title, int year, int month, int day, final OnDatePickerListener onDateTimePickerListener) {
    ...
    private void setSpecialDatePicker(int state) {
        try {
            ...
            NumberPicker view2 = (NumberPicker) ((ViewGroup) ((ViewGroup) dp.getChildAt(0)).getChildAt(0)).getChildAt(2);//获取最后一位的宽度             //年的最大值为2100            //月的最大值为11            //日的最大值为28,29,30,31
